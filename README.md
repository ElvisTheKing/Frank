...
- Open RAW files quickly through their embedded previews, then develop full-resolution data on demand, on load, or when zoom requires it.
...
- Apply non-destructive GPU exposure adjustments, normalize panes to a reference image, and match a RAW rendering to its embedded preview.
